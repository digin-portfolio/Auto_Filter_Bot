...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003779826671 -1003610940961 -1003193032701').split()]  # Channel id for auto indexing (make sure bot is admin)
